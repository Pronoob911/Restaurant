...
class ZOMATO{
	constructor(){
		this.api="d1ae7de1e1e7544d8ee805b091151608";
		this.header={
			method:"GET",
			headers:{
				"user-key":this.api,
...
//get restaurant
		const restaurantURL=`https://developers.zomato.com/api/v2.1/search?entity_id=${cityID}&entity_type=city&sort=rating`;
...
class UI{
	...
	getRestaurants(restaurants){
		...
		if(restaurants.length===0){
			showFeedback('No such city found');
		}
		else{
